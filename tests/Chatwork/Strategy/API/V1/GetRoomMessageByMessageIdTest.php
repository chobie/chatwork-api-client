...
class GetRoomMessageByMessageIdTest extends StrategyTestCase
{
    public function testExecuteWhenHTTPOK()
    {
        $fixture = $this->loadFixture("get_room_message_by_message_id.json");
        ...
        $result = $client->getRoomMessageByMessageId(123, 5);
